...
export const Portfolio: React.FC = () => {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      challenge: "Lowering a high CPC (Cost Per Click) on LinkedIn for a complex B2B product.",
      solution: "Designed simplified, benefit-led carousel ads using AI-generated metaphors for software speed.",
      results: "2.5x ROAS",
